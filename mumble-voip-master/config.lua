...
mumbleConfig = {
    voiceModes = {
        ...
        {2.5, "[2.5] Chuchoter"}, -- Whisper speech distance in gta distance units
        {8, "[8] Normal"}, -- Normal speech distance in gta distance units
        {20, "[20] Crier"}, -- Shout speech distance in gta distance units
